...
export default function AdminProfilePage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <h1 className="font-display text-2xl font-bold text-slate-900 dark:text-white">Admin profile</h1>
      ...
      <Card variant="glass" className="p-5">
        <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">Account information</p>
        <div className="mt-3 grid gap-3 sm:grid-cols-2">
          <div className="flex items-start gap-2.5">
            <ShieldCheck size={16} className="mt-0.5 shrink-0 text-brand-500 dark:text-brand-300" />
            <div>
          ...
          <div className="flex items-start gap-2.5">
            <Calendar size={16} className="mt-0.5 shrink-0 text-brand-500 dark:text-brand-300" />
            <div>
              <p className="text-[11px] uppercase tracking-wide text-slate-400">Account created</p>
